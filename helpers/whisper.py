...
def mp3_to_srt(mp3_path: Path, output_folder: str = ".", model: str = "large"):
    """
    Transcribe an audio file using Whisper and save the transcription as an SRT subtitle file.

    Args:
        mp3_path (Path): Path to the audio file to transcribe
    ...
    if not srt_path.is_file():
        ...
        transcribe = model.transcribe(str(mp3_path))
